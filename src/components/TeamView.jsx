...
export default function TeamView({ sessionCode, teamToken }) {
  ...
  useEffect(() => {
    ...
    const storageVersion = teamToken === "question" ? "v5" : teamToken === "timer" ? "v6" : teamToken === "between-rounds" ? "v5" : teamToken === "waiting" ? "v4" : ["team-name", "multiple-choice", "answer-reveal", "locked"].includes(teamToken) ? "v2" : "v1";
